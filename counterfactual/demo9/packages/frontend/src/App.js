                ...
                {loggedIn ?
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <div>
                        <Link to="/recovery">Remove recovery assist</Link>
                      </div>
                    </div>
                    : null }
                    {contractStatus === 'active' && !recoveryAddress ?
                    <div>
                      <Link to="/recovery">Add recovery address</Link>
                    </div>
                    : null}
                    <div>
                      <div>
                  ...
                  :
                [
                <Link to="/login" key="a">Login</Link>,
                <Link to="/signup" key="b">Signup</Link>,
                <Link to="/forgot-password" key="c">Forgot Password</Link>,
                ]
                }
              </UI.Nav>
            </UI.HeaderInner>
