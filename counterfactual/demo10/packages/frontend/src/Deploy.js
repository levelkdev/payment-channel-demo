...
class App extends Component {
  ...
  async deploy() {
    ...
    await this.props.deployContract(this.props.userId, recipient, amount)
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    deployContract: (userId, recipient, amount) => dispatch(deployContract(userId, recipient, amount)),
  }
}
